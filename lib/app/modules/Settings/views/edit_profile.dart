    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          labelText: label,
          labelStyle: TextStyle(color: NomAIColors.blackText),
          suffixText: suffix,
          suffixStyle: TextStyle(color: NomAIColors.blackText),
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(color: NomAIColors.grey),
          ),
          ...
          errorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(color: NomAIColors.red),
          ),
  ...
  Widget _buildDropdown<T>({
    ...
    return Padding(
      ...
      child: DropdownButtonFormField<T>(
        ...
        onChanged: onChanged,
        icon: Icon(Icons.keyboard_arrow_down, color: NomAIColors.blackText),
      ),
    );
  }
    ...
    return Padding(
      ...
      child: InkWell(
              ...
              return Theme(
                data: Theme.of(context).copyWith(
                  colorScheme: ColorScheme.light(
                    primary: NomAIColors.black,
                    onPrimary: Colors.white,
                    onSurface: NomAIColors.blackText,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(color: NomAIColors.grey),
            borderRadius: BorderRadius.circular(12),
            color: Colors.white,
          ),
          child: Row(
            ...
            children: options.map((option) {
              ...
              return FilterChip(
                label: Text(
                  option,
                  style: TextStyle(
                    color: isSelected ? Colors.white : NomAIColors.blackText,
                    fontWeight: FontWeight.w500,
                  ),
                ),
                selected: isSelected,
                ...
                selectedColor: NomAIColors.black,
                checkmarkColor: Colors.white,
                side: BorderSide(
                  color: isSelected ? NomAIColors.black : NomAIColors.grey,
                ),
                elevation: 0,
                pressElevation: 1,
              );
