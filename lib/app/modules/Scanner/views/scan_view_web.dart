...
class NomAIWebCamera extends StatefulWidget {
  const NomAIWebCamera({super.key});

  @override
  State<NomAIWebCamera> createState() => _NomAIWebCameraState();
}

class _NomAIWebCameraState extends State<NomAIWebCamera> {
